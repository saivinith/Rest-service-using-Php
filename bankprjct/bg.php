...
<body>
    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="examples.php">IFSC</a></li>
          <li class="selected"><a href="page.php">B_Name and B_City</a></li>
  ...
  <h4 align="right"><a href="page.php"> Re-Enter Bank Details code</a></h4> 
      <div id="content">
...
$bname=$_POST["bname"];
$bcity=$_POST["bcity"];
$sql = ("SELECT * FROM bank_branches WHERE bank_name='$bname' and city='$bcity'");
